...
@Composable
fun LlistarRecompensesDisponiblesScreen(
    ...
    LaunchedEffect(Unit) {
        recompensaViewModel.carregarRecompensesDisponibles()
    }
    ...
    Column(
        ...
        BottomNav(navController, usuariViewModel, 3) // Posició activa: recompenses
    }
}